...
class JaggedKeyValue( object ):
    ...
    def from_lists( key_list, val_list, dtype=np.int ):
        ...
        return JaggedKeyValue( key_list, val_list, bounds )
    ...
    def from_dense_nb( data, cols ):#, dtype=np.int ):
        ...
        n = bounds[-1]
        return JaggedKeyValue( keys[:n], values[:n], bounds )
    ...
    def from_dense( data, cols, dtype=np.int ):
        ...
        return JaggedKeyValue.from_lists( keys, values )
    ...
    def __eq__(self, other):
        if not isinstance( other, JaggedKeyValue ):
            return False
    ...
    def __getitem__( self, i ):
        ...
        if isinstance( i, slice ):
            ...
            return JaggedKeyValue( self.keys, self.values, self.bounds[s] )
    ...
    def cumsum(self):
        ...
        if self:
            ...
            return JaggedKeyValue( cs_keys, cs_vals, cs_bounds )
        else:
            return JaggedKeyValue( [], [], [] )
