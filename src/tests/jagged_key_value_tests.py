...
from special_arrays.jagged_key_value import JaggedKeyValue
...
class JaggedKeyValueArrayTests( unittest.TestCase ):
    ...
    def setUp(self):
        ...
        self.arr = JaggedKeyValue( self.keys, self.vals, self.bounds )
    ...
    def test_cumsum(self):
        ...
        e           = JaggedKeyValue.from_dense( cs, cols)
    ...
    def test_from_lists(self):
        ...
        result = JaggedKeyValue.from_lists( key_list, val_list )
    ...
    def test__getitem_1dslice1(self):
        ...
        self.assertIsInstance( r, JaggedKeyValue )
    ...
    def test_to_dense2(self):
        ...
        arr = JaggedKeyValue.from_lists( keys, values )
    ...
    def test_from_dense(self):
        ...
        data = np.array(data)
        cols = np.array(cols)
        r = JaggedKeyValue.from_dense(data, cols )
        print(r)
    ...
    def test_from_dense_nb(self):
        ...
        data = np.array(data)
        cols = np.array(cols)
        r = JaggedKeyValue.from_dense_nb(data, cols )
        print(r)
...
class MoreJaggedKeyValueArrayTests( unittest.TestCase ):
    ...
    def test_to_dense_slice_from_beginning(self):
        ...
        arr = JaggedKeyValue( keys, vals, bounds )
